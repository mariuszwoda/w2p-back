...
import pl.w2p.config.Constants;
import pl.w2p.domain.User;
import pl.w2p.repository.UserRepository;
import pl.w2p.security.AuthoritiesConstants;
import pl.w2p.service.MailService;
import pl.w2p.service.UserService;
import pl.w2p.service.dto.AdminUserDTO;
import pl.w2p.web.rest.errors.BadRequestAlertException;
import pl.w2p.web.rest.errors.EmailAlreadyUsedException;
import pl.w2p.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link pl.w2p.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
