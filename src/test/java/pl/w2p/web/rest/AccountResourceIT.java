...
import pl.w2p.IntegrationTest;
import pl.w2p.config.Constants;
import pl.w2p.domain.User;
import pl.w2p.repository.AuthorityRepository;
...
import pl.w2p.service.dto.PasswordChangeDTO;
import pl.w2p.web.rest.vm.KeyAndPasswordVM;
import pl.w2p.web.rest.vm.ManagedUserVM;
